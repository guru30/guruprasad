    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="#">Men's and Women's Wear </a></li>
<li><a href="#">Bags and Lauggages</a></li>
<li><a href="#">Mens and Womens Watches</a></li>
...
<li><a href="signup"><span class="glyphicon glyphicon-share">Sign Up</span></a></li>
    </ul>
    </div>
  </div>
</nav>
